...
public class DiskTimeoutOnDc : IWindowsChanger
{
    ...
    public void RunAction(string[] originalArguments)
    {
        ...
        SetDiskTimeoutDcMinutes(timeoutMinutes);
    }

    [SupportedOSPlatform("Windows7.0")]
    private void SetDiskTimeoutDcMinutes(string timeoutMinutes)
    {
        var processStartInfo = new ProcessStartInfo()
        {
            FileName = "powercfg.exe",
            Arguments = $"-x -disk-timeout-dc {timeoutMinutes}",
