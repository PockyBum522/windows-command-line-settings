...
public class DiskTimeoutOnAc : IWindowsChanger
{
    ...
    public void RunAction(string[] originalArguments)
    {
        ...
        SetDiskTimeoutAcMinutes(timeoutMinutes);
    }

    [SupportedOSPlatform("Windows7.0")]
    private void SetDiskTimeoutAcMinutes(string timeoutMinutes)
    {
        var processStartInfo = new ProcessStartInfo()
        {
            FileName = "powercfg.exe",
            Arguments = $"-x -disk-timeout-ac {timeoutMinutes}",
