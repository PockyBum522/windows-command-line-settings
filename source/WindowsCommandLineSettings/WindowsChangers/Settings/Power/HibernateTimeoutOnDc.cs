...
public class HibernateTimeoutOnDc : IWindowsChanger
{
    ...
    public void RunAction(string[] originalArguments)
    {
        ...
        SetHibernateTimeoutDcMinutes(timeoutMinutes);
    }

    [SupportedOSPlatform("Windows7.0")]
    private void SetHibernateTimeoutDcMinutes(string timeoutMinutes)
    {
        var processStartInfo = new ProcessStartInfo()
        {
            FileName = "powercfg.exe",
            Arguments = $"-x -hibernate-timeout-dc {timeoutMinutes}",
