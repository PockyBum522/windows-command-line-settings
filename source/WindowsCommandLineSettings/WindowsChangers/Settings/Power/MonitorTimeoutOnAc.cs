...
public class MonitorTimeoutOnAc : IWindowsChanger
{
    ...
    public void RunAction(string[] originalArguments)
    {
        ...
        SetMonitorTimeoutMinutes(timeoutMinutes);
    }

    [SupportedOSPlatform("Windows7.0")]
    private void SetMonitorTimeoutMinutes(string timeoutMinutes)
    {
        var processStartInfo = new ProcessStartInfo()
        {
            FileName = "powercfg.exe",
            Arguments = $"-x -monitor-timeout-ac {timeoutMinutes}",
